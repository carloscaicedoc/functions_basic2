...
print(print_and_return([5,50]))   
print(print_and_return([7, 49]))   
...
print(print_and_return([9, 99, 65, 43, 543]))
...
print(values_greater_than_second([5,4,6,8,10,1,2,3]))
print(values_greater_than_second([5]))
print(values_greater_than_second([3,5,7,17,11,8,14]))
...
print(this_length_that_value(3,8))
print(this_length_that_value(12,83))
